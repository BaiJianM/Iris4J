...
import com.iris.lite.java.application.memory.MemoryExtractionService;
import com.iris.lite.java.application.memory.SessionSummarizationService;
 ...
 * （{@code com.iris.lite.java.demo.config.DemoExecutorMetricsConfig}）。
 */
@Configuration
