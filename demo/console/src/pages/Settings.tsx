...
const THEME_KEY = "iris-lite.theme"
...
export default function Settings(_: PageProps) {
  ...
  const saveTheme = (t: "dark" | "light") => {
    ...
    window.dispatchEvent(new CustomEvent("iris-lite.theme-change", { detail: t === "light" }))
  }
    ...
    <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
      ...
      <Card>
        ...
        <div className="flex flex-col gap-4 p-4">
          ...
          <Button variant="primary" className="w-fit" onClick={() => window.dispatchEvent(new CustomEvent("iris-lite.settings-saved"))}>
            保存设置
          </Button>
        </div>
      </Card>
